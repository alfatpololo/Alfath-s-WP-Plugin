/**
 * Storeberry Feature Grid Tabs – vanilla JS tab controller.
 */
(function () {
	'use strict';
	...
	function onTabClick(event) {
		...
		var section = tab.closest('.sb-feature-tabs-section');
	...
	function initSection(section) {
		if (section.getAttribute('data-sb-ft-init') === '1') {
			return;
		}

		section.setAttribute('data-sb-ft-init', '1');
	...
	function initAll(root) {
		...
		var sections = scope.querySelectorAll('.sb-feature-tabs-section');
	...
	window.addEventListener('elementor/frontend/init', function () {
		...
		elementorFrontend.hooks.addAction(
			'frontend/element_ready/storeberry_feature_grid_tabs.default',
			function ($scope) {
